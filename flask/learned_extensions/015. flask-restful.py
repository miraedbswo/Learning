...
api = Api(blueprint)
# Api 클래스의 생성자에는 Flask 의 인스턴스를 직접 넣어주거나, blueprint를 전달해서 api 객체를 생성
...
# api 객체에 add_resource 해주는 방법도 있지만, api 객체의 데코레이터를 사용할 수 도 있음.
...
# flask_restful과 blueprint를 함께 사용해서 고도화된 구조화 형태의 flask application을 만드는 것이 가능하다.
